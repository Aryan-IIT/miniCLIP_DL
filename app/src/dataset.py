"""Minimal dataset wrapper used by both training and the app."""
...
class FlickrDataset(Dataset):
    def __init__(self, df, root_dir):
        ...
        # Decide which processor to load based on the config.
    ...
    def __getitem__(self, idx):
        ...
        # Flickr files can have odd types; keep the caption as a string.
        ...
        # Try to open the image, fall back to a black placeholder.
        try:
